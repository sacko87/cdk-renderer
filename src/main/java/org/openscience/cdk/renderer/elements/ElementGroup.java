...
public class ElementGroup extends AbstractRenderingElement
   ...
   */
  public ElementGroup() {
    this.elements = new ArrayList<IRenderingElement>();
  }
   ...
   */
  public void add(final IRenderingElement element) {
    if (element == null) {
      return;
    }
   ...
   */
  public void visitChildren(final IRenderingVisitor visitor) {
    for (final IRenderingElement child : this.elements) {
