...
IRenderingElement {
  ...
  /**
   * Constructs a new TextElement with the content <code>text</code> to be drawn
   * at position (x,y) in the color <code>color</code>.
   *
   * @param xCoord
   *          x coordinate where the text should be displayed
   * @param yCoord
   *          y coordinate where the text should be displayed
   * @param text
